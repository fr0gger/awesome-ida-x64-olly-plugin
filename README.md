...
* [Lazy ida](https://github.com/L4ys/LazyIDA): Add simple functionalities such as function return removing, converting data, scanning for format string vulnerabilities. 
...
* [Labeless](https://github.com/a1ext/labeless): System for labels/comments synchronization with a debugger backend, with complex memory dumping and interactive Python scripting capabilities.
